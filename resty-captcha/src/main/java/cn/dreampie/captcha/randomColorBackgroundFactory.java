 ...
 */
class RandomColorBackgroundFactory implements BackgroundFactory {
  private Random random = new Random();
  private Color bgColor = null;//背景色
  private int noiseNum = 50;//噪点数量
  private int lineNum = 1;//干扰线数量
  private Color drawColor = new Color(102, 102, 102);//干扰元素颜色 null 使用随机色

  RandomColorBackgroundFactory() {
  }

  RandomColorBackgroundFactory(Color bgColor) {
    this.bgColor = bgColor;
  }

  RandomColorBackgroundFactory(Color bgColor, Color drawColor) {
    this.bgColor = bgColor;
    this.drawColor = drawColor;
  }

  RandomColorBackgroundFactory(Color bgColor, Color drawColor, int noiseNum, int lineNum) {
    this.bgColor = bgColor;
    this.drawColor = drawColor;
