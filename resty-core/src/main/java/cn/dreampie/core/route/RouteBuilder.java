...
import cn.dreampie.core.config.InterceptorLoader;
import cn.dreampie.core.config.ResourceLoader;
import cn.dreampie.core.interceptor.Interceptor;
import cn.dreampie.core.interceptor.InterceptorBuilder;
import cn.dreampie.core.route.annotation.*;
...
public final class RouteBuilder {
  ...
  public void build() {
    ...
    //addResources
    for (Class<? extends cn.dreampie.core.route.base.Resource> resourceClazz : resourceLoader.getResources()) {
