...
public class C3p0DataSourceProvider implements DataSourceProvider {
  ...
  public C3p0DataSourceProvider(String dsName) {
    ...
    this.maxStatements = prop.getInt("db." + dsName + ".maxStatements", C3P0Defaults.maxStatements());
    this.maxStatementsPerConnection = prop.getInt("db." + dsName + ".maxStatementsPerConnection", C3P0Defaults.maxStatementsPerConnection());
    this.initialPoolSize = prop.getInt("db." + dsName + ".initialPoolSize", C3P0Defaults.initialPoolSize());
    this.minPoolSize = prop.getInt("db." + dsName + ".minPoolSize", C3P0Defaults.minPoolSize());
    this.maxPoolSize = prop.getInt("db." + dsName + ".maxPoolSize", C3P0Defaults.maxPoolSize());
    this.idleConnectionTestPeriod = prop.getInt("db." + dsName + ".idleConnectionTestPeriod", C3P0Defaults.idleConnectionTestPeriod());
    this.maxIdleTime = prop.getInt("db." + dsName + ".minEvictableIdleTimeMillis", C3P0Defaults.maxIdleTime());
    this.propertyCycle = prop.getInt("db." + dsName + ".propertyCycle", C3P0Defaults.propertyCycle());
    this.acquireIncrement = prop.getInt("db." + dsName + ".acquireIncrement", C3P0Defaults.acquireIncrement());
    this.acquireRetryAttempts = prop.getInt("db." + dsName + ".acquireRetryAttempts", C3P0Defaults.acquireRetryAttempts());
    this.acquireRetryDelay = prop.getInt("db." + dsName + ".acquireRetryDelay", C3P0Defaults.acquireRetryDelay());
    this.checkoutTimeout = prop.getInt("db." + dsName + ".checkoutTimeout", C3P0Defaults.checkoutTimeout());
    this.maxAdministrativeTaskTime = prop.getInt("db." + dsName + ".maxAdministrativeTaskTime", C3P0Defaults.maxAdministrativeTaskTime());
    this.maxIdleTimeExcessConnections = prop.getInt("db." + dsName + ".maxIdleTimeExcessConnections", C3P0Defaults.maxIdleTimeExcessConnections());
    this.maxConnectionAge = prop.getInt("db." + dsName + ".maxConnectionAge", C3P0Defaults.maxConnectionAge());
    this.unreturnedConnectionTimeout = prop.getInt("db." + dsName + ".unreturnedConnectionTimeout", C3P0Defaults.unreturnedConnectionTimeout());
    this.breakAfterAcquireFailure = prop.getBoolean("db." + dsName + ".breakAfterAcquireFailure", C3P0Defaults.breakAfterAcquireFailure());
    this.testConnectionOnCheckout = prop.getBoolean("db." + dsName + ".testConnectionOnCheckout", C3P0Defaults.testConnectionOnCheckout());
    this.testConnectionOnCheckin = prop.getBoolean("db." + dsName + ".breakAfterAcquireFailure", C3P0Defaults.testConnectionOnCheckin());
    this.autoCommitOnClose = prop.getBoolean("db." + dsName + ".breakAfterAcquireFailure", C3P0Defaults.autoCommitOnClose());
    this.automaticTestTable = prop.get("db." + dsName + ".testOnBorrow", C3P0Defaults.automaticTestTable());

    this.preferredTestQuery = prop.get("db." + dsName + ".preferredTestQuery", this.dialect.validQuery());
    buidDataSource();
  }
