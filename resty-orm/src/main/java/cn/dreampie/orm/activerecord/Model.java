  ...
  protected TableMeta getTableMeta() {
    ...
    if (useDS != null) {
      ...
      if (Metadata.hasTableMeta(useDS, tableName)) {
        ...
        tableMeta = Metadata.addTableMeta(new TableMeta(useDS, tableName, tableMeta.getId(), tableMeta.isGenerated(), tableMeta.getGenerator(), tableMeta.getPrimaryKey(), tableMeta.isCached()));
      }
    }
